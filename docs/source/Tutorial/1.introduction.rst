...
This project is based on `xiaozhi-esp32 <https://github.com/78/xiaozhi-esp32>`_. If you want to add your own features, you can follow the documentation for secondary development.
